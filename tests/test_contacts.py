...
@respx.mock
def test_get_contact_attributes() -> None:
    """Test getting contact attributes."""
    contact_id = "test_id_123"
    # Mock the API response
    route = respx.get(
        f"https://spaceship.dev/api/v1/contacts/attributes/{contact_id}"
    ).mock(
...
@respx.mock
def test_get_contact_attributes_json() -> None:
    """Test getting contact attributes in JSON format."""
    contact_id = "test_id_123"
