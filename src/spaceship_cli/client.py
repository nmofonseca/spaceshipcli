...
class SpaceshipClient:
    """
    Client to interact with Spaceship.com API.
    """

    def __init__(self) -> None:
        if not settings.api_key or not settings.api_secret:
            typer.secho(
                "Error: SPACESHIP_API_KEY and SPACESHIP_API_SECRET "
    ...
    def list_domains(
        self, limit: int = 10, offset: int = 0, order_by: Optional[str] = None
    ) -> Any:
        """
        List domains.
    ...
    def get_contact_attributes(self, contact_id: str) -> Any:
        """
    ...
    def check_availability(self, domains: list[str]) -> Any:
        """
        Check domains availability.
        Endpoint: POST /v1/domains/available
        Body: {"domains": ["example.com", ...]}
        """
        return self._post("/domains/available", json_data={"domains": domains})

    def get_personal_nameservers(self, domain: str) -> Any:
        """
    ...
    def get_domain_transfer(self, domain: str) -> Any:
        """
    ...
    def get_domain_auth_code(self, domain: str) -> Any:
        """
